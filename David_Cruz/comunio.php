...
<html>
	...
	<body>
	<?php
	$usuariosArray["David"]="Azuqueca67";
	$usuariosArray["Maria"]="1234";
    $resumen=password_hash($usuariosArray["David"], PASSWORD_DEFAULT);
    	if (password_verify($_POST["contraseña"], $resumen)){
    	    //Array equipos
